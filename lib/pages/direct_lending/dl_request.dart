...
import 'package:firebase3/pages/direct_lending/dl_request_confrim.dart';
import 'package:firebase3/pages/direct_lending/dl_start.dart';


class dl_request extends StatefulWidget {
  @override
  _dl_startState createState() => _dl_startState();
}

class _dl_startState extends State<dl_request> {
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: TextButton(
                                        onPressed: () {
                                          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => dl_request_confrim()));
                                        },
                                        child: Text(
                                          'confirm',
                                          style: TextStyle(
